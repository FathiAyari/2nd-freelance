            ...
            <div class="container-fluid">
                ...
                <div class="lgx-footer-area footer-custom-menu">
                    <div class="lgx-footer-single footer-brand">
                        <img class="brand" src="{{asset('img/event.jpg') }}" alt="{{ setting('site.site_name') }}" />

                        <p class="footer-brand-slogan">Hamza events</p>
                    </div>
                    ...
                    <div class="lgx-footer-single">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a class="col-grey"
                                    href="{{ route('eventmie.events_index') }}">@lang('eventmie-pro::em.events')</a>
                            </li>
                            <li><a class="col-grey"
                                    href="{{ route('eventmie.get_posts') }}">@lang('eventmie-pro::em.blogs')</a></li>
                            <li><a class="col-grey"
                    ...
                    <div class="lgx-footer-single">
                        ...
                        <address>Sajnen-Bizerte Tunisie </address>
                        <p class="text"><i class="fas fa-phone-alt"></i> +216 53 634 425</p>
                        <p class="text"><i class="fas fa-envelope"></i> xxxxxxxxxxxxxx@gmail.com</p>
                    ...
                    <div class="lgx-footer-single">
                        ...
                        <ul class="list-inline lgx-social-footer">
                            ...
                            <li><a href="https://www.facebook.com/maalaoui.hamza.amara" target="_blank"><i
                                        class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                            @endif

                            @if(setting('social.twitter'))
                            <li><a href="https://wa.me/+21653634425" target="_blank"><i class="fab fa-whatsapp"
                ...
                <div class="lgx-footer-area footer-custom-menu">
                    ...
                    <div class="lgx-footer-single">
                        <h3 class="footer-title"><i class="{{ $parentItem->icon_class }}"></i> {{ $parentItem->title }}
                        </h3>
                        <ul class="list-unstyled">
                ...
                <div class="lgx-footer-bottom">
                    <div class="lgx-copyright">
                        <p>
                            <span>©</span>2021
                            <a href="{{ eventmie_url() }}">Hamza events</a><br>

                            Produced by
                            <span class="developer">Fathi AYARI</span>
                        </p>
                    </div>
                </div>
