    ...
    methods: {
        ...
        formSubmit(event) {
            ...
            let post_data = {
                ...
                'end_date'         : moment(this.convert_date(this.end_date),"YYYY-MM-DD").locale('en').format('YYYY-MM-DD'),
                'start_time'       : moment(this.convert_time(this.start_time),"HH:mm:ss").locale('en').format('HH:mm:ss'),
                'end_time'         : moment(this.convert_time(this.end_time),"HH:mm:ss").locale('en').format('HH:mm:ss'),
