                    ...
                    <tbody>
                        ...
                        <tr v-for="(booking, index) in bookings" :key="index" >
                            ...
                            <td :data-title="trans('em.event')">
                                ...
                                <p class="text-small" v-if="booking.event_start_date != booking.event_end_date">{{ moment(convert_date_to_local(booking.event_start_date)).format(date_format.vue_date_format)+' - '+moment(convert_date_to_local(booking.event_end_date)).format(date_format.vue_date_format) }}</p>
                                <p class="text-small" v-else>{{ moment(convert_date_to_local(booking.event_start_date)).format(date_format.vue_date_format) }}</p>

                                <p class="text-small">{{ convert_time_to_local(booking.event_start_date, booking.event_start_time, date_format.vue_time_format)+' - '+convert_time_to_local(booking.event_end_date, booking.event_end_time, date_format.vue_time_format) }}</p>
                            </td>
